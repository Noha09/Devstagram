                ...
                <div class="mb-5">
                    ...
                    <div class="flex">
                        ...
                        <input 
                            ...
                            id="name"
                            name="name"
                            class="border-gray-300 p-3 w-full rounded-e-lg @error('name')
                    ...
                    @error('name')
                        <p class="bg-red-500 text-white my-2 rounded-lg text-center text-sm p-2">{{ str_replace('name', 'nombre', $message); }}</p>
                    @enderror
                </div>
